...
Flower Entity
------------------------ */
game.FlowerEntity1 = me.ObjectEntity.extend({
    init: function(x, y, settings) {
        settings.image = "flower_1";
...
game.FlowerEntity2 = me.ObjectEntity.extend({
    init: function(x, y, settings) {
        settings.image = "flower_2";
        settings.spritewidth = 55;
...
Butterfly Entity
------------------------ */
game.ButterflyEntity1 = me.ObjectEntity.extend({
    init: function(x, y, settings) {
        settings.image = "butterfly_1";
        settings.spritewidth = 55;
...
game.ButterflyEntity2 = me.ObjectEntity.extend({
    init: function(x, y, settings) {
        settings.image = "butterfly_2";
        settings.spritewidth = 55;
        settings.spriteheight = 48;
...
game.ButterflyEntity3 = me.ObjectEntity.extend({
    init: function(x, y, settings) {
        settings.image = "butterfly_3";
        settings.spritewidth = 55;
        settings.spriteheight = 48;
